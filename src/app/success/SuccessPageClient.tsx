      ...
      <div className="min-h-dvh bg-neutral-50">
        ...
        <div className="hidden md:block px-6xl">
          <div className="mx-auto w-full max-w-300 pt-6xl">
            <div className="h-12 w-56 rounded-xl bg-neutral-100" />
    ...
    <div className="min-h-dvh bg-neutral-50">
      ...
      <div className="hidden md:block px-6xl">
        <div className="mx-auto flex min-h-dvh w-full max-w-300 flex-col">
          ...
          <main className="flex flex-1 items-center justify-center pb-8xl">
            <div className="flex w-full flex-col items-center">
              ...
              <div className="mt-4xl text-center">
                ...
                <button
                  ...
                  className="mx-auto mt-4xl h-11 w-72 rounded-full bg-primary-600 px-4xl text-text-sm font-bold tracking-[-0.02em] text-base-white"
                >
                  See Borrowed List
                </button>
              </div>
